...
const ProductSchema = new mongoose.Schema(
  {
    ...
    category: { type: String, default: "lunche" },
...
// --- AKTUALIZACJA SŁOWNIKÓW CENOWYCH DLA FALLBACKU ---
const PRICE_LIST = {
  "bs-sm-1": 4300,
  "bs-sm-2": 4500,
  "bs-sm-3": 4700,
  ...
  "n-cappuccino": 1300,
  "n-matcha": 1900,
  "n-herbata-cytryna": 1000,
  "n-herbata-zimowa": 1600,
  "add-mleko-owsiane": 200,
  "add-mleko-kokosowe": 200,
  "add-mleko-grochowe": 200,
  "add-miod": 300
};
...
const NAME_LIST = {
  "bs-sm-1": "Box śniadaniowy mały nr 1",
  "bs-sm-2": "Box śniadaniowy mały nr 2",
  "bs-sm-3": "Box śniadaniowy mały nr 3",
  "bs-sm-vege": "Box śniadaniowy mały VEGE",
  "bs-md-1": "Box śniadaniowy średni nr 1",
  "bs-md-2": "Box śniadaniowy średni nr 2",
  "bs-md-3": "Box śniadaniowy średni nr 3",
  "bs-md-vege": "Box śniadaniowy średni VEGE",
  "bs-lg-1": "Box śniadaniowy duży nr 1",
  "bs-lg-2": "Box śniadaniowy duży nr 2",
  "bs-lg-3": "Box śniadaniowy duży nr 3",
  "bs-lg-vege": "Box śniadaniowy duży VEGE",
  "lunch-week": "Lunch tygodnia",
  "lunch-month": "Lunch miesiąca",
  "lunch-vege": "Lunch VEGE",
  "k-jaj-bekon": "Maślane pieczywo: jajecznica, bekon",
  "k-club-kurczak": "Club sandwich z kurczakiem",
  "k-club-vege": "Vege club sandwich z camembert",
  "k-jaj-avo": "Maślane pieczywo: jajecznica, awokado",
  "k-buritto": "Buritto z jajecznicą i chorizo",
  "k-rostbef": "Maślane pieczywo z rostbefem",
  "z-granola": "Domowa granola z jogurtem greckim",
  "z-cezar": "Sałatka Cezar",
  "z-koreanska": "Sałatka koreańska",
  "z-burak": "Sałatka z carpaccio z buraka",
  "s-smoothie": "Smoothie Mango Lassi",
  "s-tost": "Tost francuski z owocami i miodem",
  "s-pancakes": "Pancakes (2 szt.) z Nutellą",
  "s-deser": "Deser czekoladowy z owocami",
  "n-lemoniada": "Domowa lemoniada 250 ml",
  "n-sok": "Sok pomarańczowy 250 ml",
  "n-kawa-czarna": "Kawa filtrowana czarna 300 ml",
  "n-kawa-biala": "Kawa filtrowana biała 300 ml",
  "n-espresso": "Kawa czarna (podwójne espresso) 300 ml",
  "n-flat-white": "Kawa Flat White 300 ml",
  "n-latte": "Latte 300 ml",
  "n-cappuccino": "Cappuccino 300 ml",
  "n-matcha": "Matcha 300 ml",
  "n-herbata-cytryna": "Herbata czarna z cytryną 300 ml",
  "n-herbata-zimowa": "Zimowa herbata 300 ml",
  "add-mleko-owsiane": "Dodatek: Mleko owsiane",
  "add-mleko-kokosowe": "Dodatek: Mleko kokosowe",
  "add-mleko-grochowe": "Dodatek: Mleko grochowe",
  "add-miod": "Dodatek: Miód 50 ml"
};
// --------------------------------------------------------
...
async function seedProducts() {
  try {
    ...
    const ALL_PRODUCTS = [
      { id:'bs-sm-1', category: 'boxy-sniadaniowe', name:'Box śniadaniowy mały nr 1', price: 4300, image:'https://i.imgur.com/eom3rVn.jpeg', description:'Kanapka z jajecznicą i bekonem, majonez sriracha • Domowa granola z jogurtem greckim, owocami i miodem • Sok pomarańczowy 250 ml' },
      { id:'bs-sm-2', category: 'boxy-sniadaniowe', name:'Box śniadaniowy mały nr 2', price: 4500, image:'https://i.imgur.com/4O2NNaB.jpeg', description:'Buritto z jajecznicą i chorizo • Sałatka koreańska z kurczakiem w panko, warzywami i sezamem • Sok pomarańczowy 250 ml' },
      { id:'bs-sm-3', category: 'boxy-sniadaniowe', name:'Box śniadaniowy mały nr 3', price: 4700, image:'https://i.imgur.com/ErBUGrk.jpeg', description:'Kanapka z rostbefem, jajkiem poche, sosem musztardowo-chrzanowym i oliwą truflową • Sałatka Cezar z kurczakiem, bekonem, sałatą rzymską i grzankami • Sok pomarańczowy 250 ml' },
      { id:'bs-sm-vege', category: 'boxy-sniadaniowe', name:'Box śniadaniowy mały VEGE', price: 4300, image:'https://i.imgur.com/CLHRTL9.jpeg', description:'Kanapka z jajecznicą i awokado, majonez sriracha • Sałatka z carpaccio z buraka z kozim serem i orzechami pekan, mix sałat, pomarańczowy dressing z oliwą • Sok pomarańczowy 250 ml' },
      { id:'bs-md-1', category: 'boxy-sniadaniowe', name:'Box śniadaniowy średni nr 1', price: 5800, image:'https://i.imgur.com/QTpLAsM.jpeg', description:'Skład małego nr 1 + Tost francuski z owocami i miodem' },
      { id:'bs-md-2', category: 'boxy-sniadaniowe', name:'Box śniadaniowy średni nr 2', price: 6000, image:'https://i.imgur.com/N1BOLT8.jpeg', description:'Skład małego nr 2 + Pancakes (2 szt.) z Nutellą i owocami' },
      { id:'bs-md-3', category: 'boxy-sniadaniowe', name:'Box śniadaniowy średni nr 3', price: 6200, image:'https://i.imgur.com/nFAk3Mf.jpeg', description:'Skład małego nr 3 + Deser czekoladowy z owocami i kruszonką' },
      { id:'bs-md-vege', category: 'boxy-sniadaniowe', name:'Box śniadaniowy średni VEGE', price: 5800, image:'https://i.imgur.com/P3nuucU.jpeg', description:'Skład małego VEGE + Smoothie Mango Lassi z miodem' },
      { id:'bs-lg-1', category: 'boxy-sniadaniowe', name:'Box śniadaniowy duży nr 1', price: 8700, image:'https://i.imgur.com/fpAw7zH.jpeg', description:'Zawiera m.in. kanapkę z bekonem, club sandwich z kurczakiem, granolę, sałatkę Cezar, tost francuski i sok' },
      { id:'bs-lg-2', category: 'boxy-sniadaniowe', name:'Box śniadaniowy duży nr 2', price: 8900, image:'https://i.imgur.com/VINVw4c.jpeg', description:'Zawiera m.in. buritto z chorizo, kanapkę z bekonem, sałatkę koreańską, granolę, pancakes i sok' },
      { id:'bs-lg-3', category: 'boxy-sniadaniowe', name:'Box śniadaniowy duży nr 3', price: 9100, image:'https://i.imgur.com/0fc2NHh.jpeg', description:'Zawiera m.in. kanapkę z rostbefem, kanapkę z bekonem, sałatkę Cezar, granolę, deser czekoladowy i sok' },
      { id:'bs-lg-vege', category: 'boxy-sniadaniowe', name:'Box śniadaniowy duży VEGE', price: 8700, image:'https://i.imgur.com/Gtl4J4b.jpeg', description:'Zawiera m.in. kanapkę z awokado, vege club sandwich, sałatkę z burakiem, granolę, smoothie i sok' },
      
      { id: "lunch-week", category: "lunche", name: "Lunch tygodnia", price: 5500, description: "Zupa krem z buraka z serem kozim • Medaliony z polędwiczki wieprzowej, sos kurkowy, pieczone ziemniaki, colesław • Domowa lemoniada 300 ml", image: "https://i.imgur.com/sn5VMfS.jpeg" },
      { id: "lunch-month", category: "lunche", name: "Lunch miesiąca", price: 6500, description: "Zupa krem z pieczonych buraków 200 ml • Kurczak Supreme: pieczona pierś z kurczaka z ziemniaczanym puree, warzywami i sosem demi glace • Domowa lemoniada 250 ml", image: "https://i.imgur.com/xGCYJZQ.jpeg" },
      { id: "lunch-vege", category: "lunche", name: "Lunch VEGE", price: 5500, description: "Zupa krem z pieczonych buraków 200 ml • Tagliatelle z warzywami, oliwą z oliwek i pastą truflową • Domowa lemoniada 250 ml", image: "https://i.imgur.com/0hvAvxJ.jpeg" },
      
      { id:'k-jaj-bekon', category: 'kanapki', name:'Maślane pieczywo z jajecznicą, bekonem i majonezem sriracha', price: 1900, description: 'Maślane pieczywo z jajecznicą, bekonem i majonezem sriracha', image:'https://i.imgur.com/QZlDhsa.jpeg' },
      ...
      { id:'k-jaj-avo', category: 'kanapki', name:'Maślane pieczywo z jajecznicą, awokado i majonezem sriracha', price: 1800, description: 'Maślane pieczywo z jajecznicą, awokado i majonezem sriracha', image:'https://i.imgur.com/nkLtUQG.jpeg' },
      { id:'k-buritto', category: 'kanapki', name:'Buritto z jajecznicą z mozzarellą i chorizo', price: 2000, description: 'Buritto z jajecznicą z mozzarellą, chorizo i majonezem sriracha', image:'https://i.imgur.com/Ixbu5bk.jpeg' },
      { id:'k-rostbef', category: 'kanapki', name:'Maślane pieczywo z rostbefem i jajkiem poche', price: 2200, description: 'Maślane pieczywo z rostbefem, jajkiem poche, rukolą, sosem musztardowo-chrzanowym i oliwą truflową', image:'https://i.imgur.com/iF8vvVj.jpeg' },
      
      { id:'z-granola', category: 'zdrowe', name:'Domowa granola z jogurtem greckim', price: 2000, description: 'Domowa granola z jogurtem greckim, owoce i miód', image:'https://i.imgur.com/qOZTV6Y.jpeg' },
      ...
      { id:'s-tost', category: 'slodkie', name:'Tost francuski z owocami i miodem', price: 2000, description: 'Tost francuski z owocami i miodem', image:'https://i.imgur.com/JwN4PMV.jpeg' },
      ...
      { id:'s-deser', category: 'slodkie', name:'Deser czekoladowy z owocami', price: 2000, description: 'Deser czekoladowy z owocami i kruszonką', image:'https://i.imgur.com/mVjnusq.jpeg' },
      ...
      { id:'n-sok', category: 'napoje', name:'Sok pomarańczowy 250 ml', price: 1300, description: 'Sok pomarańczowy 250 ml', image:'https://i.imgur.com/vOgARPy.jpeg' },
      { id:'n-kawa-czarna', category: 'napoje', name:'Kawa filtrowana czarna 300 ml', price: 1100, description: 'Kawa filtrowana czarna 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'n-kawa-biala', category: 'napoje', name:'Kawa filtrowana biała 300 ml', price: 1100, description: 'Kawa filtrowana biała 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'n-espresso', category: 'napoje', name:'Kawa czarna (podwójne espresso) 300 ml', price: 1200, description: 'Kawa czarna (podwójne espresso) 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      ...
      { id:'n-cappuccino', category: 'napoje', name:'Cappuccino 300 ml', price: 1300, description: 'Cappuccino (podwójne espresso) 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'n-matcha', category: 'napoje', name:'Matcha 300 ml', price: 1900, description: 'Matcha 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'n-herbata-cytryna', category: 'napoje', name:'Herbata czarna z cytryną 300 ml', price: 1000, description: 'Herbata czarna z cytryną 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'n-herbata-zimowa', category: 'napoje', name:'Zimowa herbata 300 ml', price: 1600, description: 'Zimowa herbata z miodem, cytrusami, goździkami i sokiem malinowym 300 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'add-mleko-owsiane', category: 'napoje', name:'Dodatek: Mleko owsiane', price: 200, description: 'Mleko owsiane', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'add-mleko-kokosowe', category: 'napoje', name:'Dodatek: Mleko kokosowe', price: 200, description: 'Mleko kokosowe', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'add-mleko-grochowe', category: 'napoje', name:'Dodatek: Mleko grochowe', price: 200, description: 'Mleko grochowe', image:'https://i.imgur.com/AbtHMCT.jpeg' },
      { id:'add-miod', category: 'napoje', name:'Dodatek: Miód 50 ml', price: 300, description: 'Miód 50 ml', image:'https://i.imgur.com/AbtHMCT.jpeg' }
    ];
